...
begin
  ...
  // Topa vurduðun an hedefin gideceði yeri göster
  // Gösterilen hedefi biz visible ile gizledik.
  with FloatAniMoveAndroal do
    ...
    begin
      ...
      // rakip oyuncu atýlan hedefe doðru harekete geçsin
      duration := 0.15 + random * 0.25; // rakip hýzý
      StartValue := P.X;
      StopValue := M.X;
      start;
    end;
